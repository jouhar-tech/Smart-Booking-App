<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Register.aspx.cs" Inherits="UserCRUDApp.Register" %>
        ...
        <div class="container">
            ...
            <div class="form-group">
                ...
                <asp:TextBox ID="txtEmail" runat="server" CssClass="form-control" 
                    TextMode="Email" placeholder="Enter email" required="required"></asp:TextBox>
            </div>
            ...
            <div class="form-group">
                ...
                <asp:TextBox ID="txtConfirmPassword" runat="server" CssClass="form-control" 
                    TextMode="Password" placeholder="Confirm password" required="required"></asp:TextBox>
            </div>
